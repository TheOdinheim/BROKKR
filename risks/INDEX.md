...
| RISK-2026-0006 | A defeated freshness check survived four phases of review (OQGF-M-14 / I-13) — held-clock class across **three crates** (gate, bifrost, sentinel); grep matched shape not property | ThreatModel (P8.5 buildability check; ARCH Rev 1.15 / CLAUDE.md v1.7 I-13) | Possible | Major | Reduce | Open — SINDRI ✓ + BIFRÖST ✓; **sentinel ✗ BLOCKED** (EIR+HEIMDALL 4 held-clock comparisons are core-trait methods → needs a brokkr-core trait rev first, **GAP-2026-08-18-002**). Closure evidence corrected: grep → **exhaustive comparison table** (not clean). P-4/P-8.3/8.5/8.6 → PARTIAL (backward) | core trait rev (DAP) → re-issue brokkr-sentinel I-13 rev |
