...
| RISK-2026-0006 | A defeated freshness check survived four phases of review (OQGF-M-14 / I-13) — SINDRI held `now` at construction; freshness passed while enforcing nothing; class recurred in BIFRÖST | ThreatModel (P8.5 buildability check; ARCH Rev 1.15 / CLAUDE.md v1.7 I-13) | Possible | Major | Reduce | Open — core I-13 rev landed (7d47d2a); **until SINDRI + BIFRÖST threaded to call-site `now` AND held-clock grep is empty** | `brokkr-gate` (SINDRI) rev + Phase 8.5 rebuild (both follow) |
