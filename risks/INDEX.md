...
| RISK-2026-0006 | A defeated freshness check survived four phases of review (OQGF-M-14 / I-13) — SINDRI held `now` at construction; freshness passed while enforcing nothing; class recurred in BIFRÖST | ThreatModel (P8.5 buildability check; ARCH Rev 1.15 / CLAUDE.md v1.7 I-13) | Possible | Major | Reduce | Open — core I-13 rev (7d47d2a) + **SINDRI half CLOSED 18 Aug (held clock removed, two-verdict test, gate grep empty)**; BIFRÖST still holds `self.now()` (E0050) → **until Phase 8.5 rebuild AND workspace grep empty** | ~~`brokkr-gate` (SINDRI) rev~~ done → Phase 8.5 rebuild (BIFRÖST) remains |
